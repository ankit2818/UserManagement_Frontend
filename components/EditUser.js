...
const EditUser = ({id, isIdSame, setResponseUser}) => {
            ...
            <div className="min-h-screen px-4 text-center">
                ...
                leaveTo="opacity-0 scale-95">
                    <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-md">
                        <Dialog.Title
                        as="h3"
                        className="text-lg font-medium leading-6 text-gray-900">Update User</Dialog.Title>
                        <div className="flex max-w-md mx-auto">
                            <div className="py-2">
                                ...
                                <div className="h-14 my-4 space-x-4 pt-4">
                                    <button onClick={updateUser} className="rounded-sm text-white font-semibold bg-green-400 hover:bg-green-700 py-2 px-6">Update</button>
